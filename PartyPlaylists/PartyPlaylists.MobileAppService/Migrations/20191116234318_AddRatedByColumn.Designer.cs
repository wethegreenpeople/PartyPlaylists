...
namespace PartyPlaylists.MobileAppService.Migrations
{
    ...
    [Migration("20191116234318_AddRatedByColumn")]
    partial class AddRatedByColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyPlaylists.Models.DataModels.Token", b =>
                {
                    ...
                    b.Property<int?>("RoomSongRoomId");

                    b.Property<int?>("RoomSongSongId");
                    ...
                    b.HasIndex("RoomSongRoomId", "RoomSongSongId");
            ...
            modelBuilder.Entity("PartyPlaylists.Models.DataModels.Token", b =>
                {
                    b.HasOne("PartyPlaylists.Models.DataModels.RoomSong")
                        .WithMany("RatedBy")
                        .HasForeignKey("RoomSongRoomId", "RoomSongSongId");
                });
